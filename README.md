...
- email-листи для інформування замовника про стадії виконання етапів;
...
- `/account` — особистий кабінет; вміст визначається cookie-сесією користувача.
  На цій сторінці замовник може увійти або самостійно створити кабінет разом із новою заявою, обравши доступну станцію/компанію.
