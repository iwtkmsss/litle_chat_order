  ...
  return [
    {
      ...
      description: 'Це корисні дані з заявки та пов’язаних додатків. Для Додатків 3, 4 і 5 ці значення також підставляються в шаблон нижче, якщо у шаблоні є відповідні плейсхолдери.',
      rows: primaryRows,
    },
    {
